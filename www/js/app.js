...
var moneyleashapp = angular.module('moneyleash', ['ionic', 'firebase', 'moneyleash.controllers', 'moneyleash.directives', 'moneyleash.factories', 'pascalprecht.translate', 'ionic-datepicker', 'ngAnimate'])
...
moneyleashapp.config(function ($ionicConfigProvider, $stateProvider, $urlRouterProvider, $translateProvider) {
    ...
    .state('app.transactionsByMonth', {
        url: "/accounts/:accountId/:accountName",
        views: {
            'menuContent': {
                templateUrl: "templates/transactionsByMonth.html",
                controller: 'TransactionsController'
            }
        }
    })
