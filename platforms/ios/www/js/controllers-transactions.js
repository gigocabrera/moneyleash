...
// TRANSACTIONS CONTROLLER
moneyleashapp.controller('TransactionsByDayController', function ($scope, $state, $stateParams, $ionicListDelegate, $ionicActionSheet, AccountsFactory, PickTransactionServices, $ionicFilterBar) {
